...
public class C06_equals_equalsIgnoreCase { public static void main(String[] args) {
    ...
    System.out.println(str1.equalsIgnoreCase(str2)); //  j ava <==> Java  false
    System.out.println(str1.equalsIgnoreCase(str3)); //   java <==> JAVA  false
    System.out.println(str1.equalsIgnoreCase(str4)); //   java <==> Java  fals
    ...
    System.out.println(str3.equals(str5)); // JAVA <==> JAVA  false  sonda bosluk
